  ...
  render(){
    return (
      <div className="wrapper">
        <main className="reactivation">
          <section className="section-1 container transparent">
            <h2 className="headline text-center cornflower-blue">Votre période d'essai est terminée, c'est le moment de mettre à niveau</h2>
...
export class Reactivation extends React.Component {
  render(){
    return (
      <Tabs selected={0}>
        <Panel title="mensuel">
