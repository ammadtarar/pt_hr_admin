        ...
        <hr/>
          <div className="row-fluid">
            <div className="large-8 columns">
              <h3>
                Le Client paiera un <span className="editable">forfait</span> de <span className="editable">3200 €</span>.<br/>
                Avant le début des travaux, le Client paiera un acompte de 30%, soit <span className="editable">960 €</span>.<br/>
                ...
                Ce contrat débutera le <span className="editable">25 septembre 2018</span> et se terminera à <span className="editable">une date précise</span>.<br/>
