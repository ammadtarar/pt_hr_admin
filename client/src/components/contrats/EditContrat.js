...
class EditContrat extends React.Component {
  constructor() {
    ...
    const objetMission = 'Details to be provided'
    const startDate = 'September 25, 2018'
    const finishDate = 'October 25, 2018'
    const daysEndingContract = '7 days'
    const conditionEndingContract = 'The Client will pay the Developer for the work done up until when the Contract ends and will reimburse the Developer for any agreed-upon, non-cancellable expenses.'
    const droitClient = '2.1 Client Owns All Work Product.'
    ...
    this.state = {
      ...
      printContrat: {
        'contrat': {
          'date':'25/09/2018',
          'clientNom':'Roberto Santaolala',
          'clientNomLabel':'Nom du client',
          ...
          '\n' +
          '1. Work and Payment.\n' +
          '1.1 Project. The Client is hiring the Developer to do the following: "' + objetMission + '".\n' +
          '\n' +
          '1.2 Schedule. The Developer will begin work on ' + startDate + ' and must finish the work by ' + finishDate + '.\n' +
          '\n' +
          '1.3 Payment. The Client will pay the Developer a flat fee of $3,200.00 (USD). Of this, the Client will pay the Developer $500.00 before work begins.\n' +
          '\n' +
          ...
          'This Contract ends on ' + finishDate + ', unless the Client or the Developer ends the contract before that time. Either party may end this Contract for any reason by sending an email or letter to the other party, informing the recipient that the sender is ending the Contract and that the Contract will end in "' + daysEndingContract + '". The Contract officially ends once that time has passed. The party that is ending the Contract must provide notice by taking the steps explained in Section 11.4. The Developer must immediately stop working as soon as it receives this notice, unless the notice says otherwise. ' + conditionEndingContract + ' The following sections don’t end even after the Contract ends: 2 (Ownership and Licenses); 3 (Competitive Engagements); 4 (Non-Solicitation); 5 (Representations); 8 (Confidential Information); 9 (Limitation of Liability); 10 (Indemnity); and 11 (General).\n' +
          '\n' +
          '7. Independent Contractor.\n' +
          "The Client is hiring the Developer as an independent contractor. The following statements accurately reflect their relationship: The Developer will use its own equipment, tools, and material to do the work. — The Client will not control how the job is performed on a day-to-day basis. Rather, the Developer is responsible for determining when, where, and how it will carry out the work. — The Client will not provide the Developer with any training. — The Client and the Developer do not have a partnership or employer-employee relationship. — The Developer cannot enter into contracts, make promises, or act on behalf of the Client. — The Developer is not entitled to the Client's benefits (e.g., group insurance, retirement benefits, retirement plans, vacation days). — The Developer is responsible for its own taxes. — The Client will not withhold social security and Medicare taxes or make payments for disability insurance, unemployment insurance, or workers compensation for the Developer or any of the Developer’s employees or subcontractors.\n" +
          '\n' +
          ...
          '\n' +
          '11.7 Governing Law. The laws of ' + lieuTribunal + ' govern the rights and obligations of the Client and the Developer under this Contract, without regard to conflict of law principles of that state.\n' +
          '\n' +
