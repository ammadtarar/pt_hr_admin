...
export default (doc, printData, startY, fontSize, lineSpacing) => {
    ...
    const tablecol2X = 350;
    const tablecol3X = 470;
    ...
    doc.text(printData.label.tableTarif, tablecol2X + 45, startY, 'right');
    doc.text(printData.label.tableQty, tablecol3X - 10, startY, 'right');
    ...
    items.map(item => {
        ...
        doc.text(item.tarif, tablecol2X + 45, startY, 'right');
        doc.text(item.qty, tablecol3X - 10, startY, 'right');
